...
<!DOCTYPE html>
<html lang="pt-br">
<jsp:include page="head.jsp"></jsp:include><!-- aqui eu faço o include do head -->
  ...
  <div class="modal-dialog" role="document">
	...
	<script type="text/javascript">
	  ...
	  function criarDelete(){
		  if(confirm('Deseja realmente excluir os dados?')){/*confirm() é um metodo do java script*/
		  document.getElementById("userforms").method='get';/*passa o formulario para o metoodo get*/
		  document.getElementById("acao").value = 'deletar';/*atribuição a acao*/
	  ...
	  // com ajax não existe redirecionamento ele não faz envio de formulario html
	  // ele envia os dados por parametro e não precisa recarregar a tela.
	  
	  function criarDeleteComAjax(){
		  if(confirm("Deseja realmente excluir os dados?")){
			  let urlAction = document.getElementById('userforms').action;// aqui pego o action do formulario, ação para onde vai.
			  ...
			  }).fail(function(xhr, status,errorthrown){// o faill se caso de erro, o xhr traz os detalhes do erro, status que é o status do erro, errorthrown é a exceção do erro.
           ...
           $.ajax({
        	   ...
        	   success: function(response){
        		   ...
        		   for(let p=0; p < valorJson.length; p++){
        			   // $()funcção jquery e append() adiciona o valor
